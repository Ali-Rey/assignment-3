...
The data appears to suggest that females are consistently more likely on average to have lower political interest than males. From Waves a-e, both men and women are more likely to be on the lower end of the scale (ie. Responding as 3 or 4), however men become more interested (More likely to respond 1 or 2) in Waves f and q. Interestingly, the fluctuations in interest in sexes between waves seem to be rise and fall in tandem (The exception to this being Wave C to D).
